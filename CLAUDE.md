...
- **React Components** in `src/components/`:
  ...
  - `PatternCloudPanel` - The sidebar's Cloud section (per-pattern upload/update state; connected users only)
