/**
 * A browse-grid pattern card: the site's own render of the pattern, framed at the grid's
 * design width and scaled into a fixed square tile — centered when it is shorter than the
 * tile and cropped when it is taller — the Site Editor's pattern grid, and the same tile
 * the cloud grid uses.
 *
